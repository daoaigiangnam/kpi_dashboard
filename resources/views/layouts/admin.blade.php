...
<aside class="nav" id="adminNav">
    ...
    <div class="nav-links">
        ...
        @if(auth()->user()->hasPermission('users.view'))
            ...
            @if(auth()->user()->isSuperAdmin())<a href="{{ route('admin.users.pending') }}">Pending Registrations</a>@endif
        @endif
        ...
        @if(auth()->user()->hasPermission('it_tools.view'))
            ...
            <a href="{{ route('admin.it_tools.index') }}">IT Outsourcing Tools</a>
            <a href="{{ route('admin.it_tools.history') }}">IT Audit History</a>
        @endif
