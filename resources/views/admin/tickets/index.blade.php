...
<div class="card">
    <div class="ticket-toolbar">
        <div>
            ...
            <div class="muted">Import raw Ticket data from Bitrix/Excel. Each import is assigned to one active Employee. KPI calculation fields are generated from the configured KPI Parameters.</div>
        </div>
        <div class="actions">
