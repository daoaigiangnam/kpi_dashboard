...
<div class="card">
 ...
 <div class="table-wrap"><table class="table" style="min-width:1250px"><thead><tr><th>Employee Code</th><th>Name</th><th>Email</th><th>Department</th><th>Unit</th><th>Job Title</th><th>Target WP</th><th>Group</th><th>Actions</th></tr></thead><tbody>
 @forelse($users as $u)
 <tr>
 ...
 @empty
 <tr><td colspan="9" class="muted">{{ $showDeleted ? 'No deleted users found.' : 'No users found.' }}</td></tr>
 @endforelse
