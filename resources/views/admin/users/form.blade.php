...
<div class="field"><label>Department / Team</label><input class="input" name="department" value="{{ old('department',$user->department) }}" placeholder="IT Operations"></div>
<div class="field"><label>Work Location</label><input class="input" name="location" value="{{ old('location',$user->location) }}" placeholder="HCMC / Hanoi / Remote"></div>
