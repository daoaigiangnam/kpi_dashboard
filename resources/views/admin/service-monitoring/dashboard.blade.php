...
<div class="card" style="margin-bottom:16px;border:2px solid #dc2626;background:#fef2f2">
    <div style="font-size:18px;font-weight:700;color:#b91c1c">🔴 Network / VPS Service đang OFFLINE</div>
    <div style="margin-top:6px;color:#7f1d1d">Có <strong>{{ $networkStats['offline'] }}</strong> dịch vụ đang mất kết nối hoặc có TCP port được giám sát bị DOWN. Vui lòng kiểm tra ngay.</div>
</div>
@endif
...
<div class="grid" style="margin-top:16px">
    <div class="card"><div class="muted">FTTH / VPS / Network</div><h2>{{ $networkStats['total'] }}</h2></div>
...
<div class="card" style="margin-top:16px">
    <div class="actions" style="justify-content:space-between">
        <div><h3 style="margin:0">Service Monitoring</h3><div class="muted">Expiry alerts and continuous PING / TCP port checks for Internet, FTTH and VPS services.</div></div>
...
<div class="card" style="margin-top:16px">
    <h3>FTTH / VPS / Network Status</h3>
    <div class="table-wrap"><table class="table">
        <thead><tr><th>Status</th><th>Customer</th><th>Service</th><th>Type</th><th>Responsible IT</th><th>Provider</th><th>Target</th><th>Method</th><th>Port(s)</th><th>Latency</th><th>Loss</th><th>Failures</th><th>Last Check</th></tr></thead>
        <tbody>
...
<div class="card" style="margin-top:16px">
    <h3>Open Network / VPS Incidents</h3>
    <div class="table-wrap"><table class="table">
        <thead><tr><th>Down Since</th><th>Customer</th><th>Service</th><th>Responsible IT</th><th>Provider</th><th>Target</th><th>Method</th><th>Failed Port</th><th>Reason</th></tr></thead>
        <tbody>
        ...
        @empty
            <tr><td colspan="9" class="muted">No open network / VPS incidents.</td></tr>
        @endforelse
        </tbody>
    </table></div>
</div>
