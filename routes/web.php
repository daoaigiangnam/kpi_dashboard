...
use App\Http\Controllers\Admin\ServiceAlertPolicyController;
use App\Http\Controllers\Admin\ServiceAlertEventController;
...
Route::middleware('auth')->prefix('admin')->name('admin.')->group(function(){
    Route::get('/',function(){
        if(auth()->user()->hasPermission('admin.view')) return redirect()->route('admin.dashboard');
    ...
    Route::get('tickets',[TicketKpiPageController::class,'index'])->middleware('permission:kpi.tickets')->name('tickets.index');
    ...
    Route::get('service-types',[ServiceTypeController::class,'index'])->middleware('permission:service_types.view')->name('service_types.index');
    Route::get('service-types/create',[ServiceTypeController::class,'create'])->middleware('permission:service_types.view')->name('service_types.create');
    Route::post('service-types',[ServiceTypeController::class,'store'])->middleware('permission:service_types.view')->name('service_types.store');
    Route::get('service-types/{serviceType}/edit',[ServiceTypeController::class,'edit'])->middleware('permission:service_types.view')->name('service_types.edit');
    Route::put('service-types/{serviceType}',[ServiceTypeController::class,'update'])->middleware('permission:service_types.view')->name('service_types.update');
    Route::delete('service-types/{serviceType}',[ServiceTypeController::class,'destroy'])->middleware('permission:service_types.view')->name('service_types.destroy');
    Route::patch('service-types/{serviceType}/restore',[ServiceTypeController::class,'restore'])->middleware('permission:service_types.view')->name('service_types.restore');

    Route::get('service-customers',[ServiceCustomerController::class,'index'])->middleware('permission:service_customers.view')->name('service_customers.index');
    Route::get('service-customers/create',[ServiceCustomerController::class,'create'])->middleware('permission:service_customers.view')->name('service_customers.create');
    Route::post('service-customers',[ServiceCustomerController::class,'store'])->middleware('permission:service_customers.view')->name('service_customers.store');
    Route::get('service-customers/{serviceCustomer}/edit',[ServiceCustomerController::class,'edit'])->middleware('permission:service_customers.view')->name('service_customers.edit');
    Route::put('service-customers/{serviceCustomer}',[ServiceCustomerController::class,'update'])->middleware('permission:service_customers.view')->name('service_customers.update');
    Route::delete('service-customers/{serviceCustomer}',[ServiceCustomerController::class,'destroy'])->middleware('permission:service_customers.view')->name('service_customers.destroy');
    Route::patch('service-customers/{serviceCustomer}/restore',[ServiceCustomerController::class,'restore'])->middleware('permission:service_customers.view')->name('service_customers.restore');

    Route::get('service-providers',[ServiceProviderController::class,'index'])->middleware('permission:service_providers.view')->name('service_providers.index');
    ...
    Route::get('services/export-details',[ServiceToolsController::class,'export'])->middleware('permission:services.view')->name('services.export_details');
    Route::post('services/{service}/detect-expiry',[ServiceToolsController::class,'detectDomainExpiry'])->middleware('permission:services.view')->name('services.detect_expiry');
    Route::get('services',[ServiceController::class,'index'])->middleware('permission:services.view')->name('services.index');
    Route::get('services/create',[ServiceController::class,'create'])->middleware('permission:services.view')->name('services.create');
    Route::post('services',[ServiceController::class,'store'])->middleware('permission:services.view')->name('services.store');
    Route::get('services/{service}/edit',[ServiceController::class,'edit'])->middleware('permission:services.view')->name('services.edit');
    Route::put('services/{service}',[ServiceController::class,'update'])->middleware('permission:services.view')->name('services.update');
    Route::delete('services/{service}',[ServiceController::class,'destroy'])->middleware('permission:services.view')->name('services.destroy');
    Route::patch('services/{service}/restore',[ServiceController::class,'restore'])->middleware('permission:services.view')->name('services.restore');

    Route::get('service-alert-policies',[ServiceAlertPolicyController::class,'index'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.index');
    Route::get('service-alert-policies/create',[ServiceAlertPolicyController::class,'create'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.create');
    Route::post('service-alert-policies',[ServiceAlertPolicyController::class,'store'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.store');
    Route::get('service-alert-policies/{serviceAlertPolicy}/edit',[ServiceAlertPolicyController::class,'edit'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.edit');
    Route::put('service-alert-policies/{serviceAlertPolicy}',[ServiceAlertPolicyController::class,'update'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.update');
    Route::delete('service-alert-policies/{serviceAlertPolicy}',[ServiceAlertPolicyController::class,'destroy'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.destroy');
    Route::patch('service-alert-policies/{serviceAlertPolicy}/restore',[ServiceAlertPolicyController::class,'restore'])->middleware('permission:service_alert_policies.view')->name('service_alert_policies.restore');

    Route::get('service-alert-events',[ServiceAlertEventController::class,'index'])->middleware('permission:service_alert_events.view')->name('service_alert_events.index');
    Route::post('service-alert-events/{serviceAlertEvent}/acknowledge',[ServiceAlertEventController::class,'acknowledge'])->middleware('permission:service_alert_events.view')->name('service_alert_events.acknowledge');
    Route::post('service-alert-events/{serviceAlertEvent}/resolve',[ServiceAlertEventController::class,'resolve'])->middleware('permission:service_alert_events.view')->name('service_alert_events.resolve');

    Route::get('service-monitoring',[ServiceMonitoringController::class,'index'])->middleware('permission:service_monitoring.view')->name('service_monitoring.index');
    Route::post('service-monitoring/run',[ServiceMonitoringController::class,'run'])->middleware('permission:service_monitoring.run')->name('service_monitoring.run');
    ...
    Route::get('it-tools/api-tester',[ItToolsController::class,'apiTesterPage'])->middleware('permission:it_tools.view')->name('it_tools.api_tester_page');
